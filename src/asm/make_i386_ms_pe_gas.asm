...
.text
.p2align 4,,15
.globl	_make_zcontext
.def	_make_zcontext;	.scl	2;	.type	32;	.endef
_make_zcontext:
    ...
    movl  %ecx, 0x14(%eax)
    /* second arg of make_zcontext() == size of context-stack */
    movl  0x08(%esp), %edx
    ...
    /* third arg of make_zcontext() == address of context-function */
    movl  0xc(%esp), %ecx
    movl  %ecx, 0x2c(%eax)
