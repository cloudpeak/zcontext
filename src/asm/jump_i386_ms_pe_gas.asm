...
.text
.p2align 4,,15
.globl	_jump_zcontext
.def	_jump_zcontext;	.scl	2;	.type	32;	.endef
_jump_zcontext:
...
1:
    /* first arg of jump_zcontext() == context jumping from */
    movl  0x30(%esp), %eax

    /* store ESP (pointing to context-data) in EAX */
    movl  %esp, (%eax)

    /* second arg of jump_zcontext() == context jumping to */
    movl  0x34(%esp), %edx

    /* third arg of jump_zcontext() == value to be returned after jump */
    movl  0x38(%esp), %eax
